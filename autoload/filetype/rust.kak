...
add-highlighter shared/rust/code/keyword      regex \b(?<!r#)(use|mod|struct|enum|union|type|await|async|(?:async\s+)?fn|trait|impl|return|if|match|where|in|as|else|for|while|loop|const|static|let|mut|ref|dyn|box?:|pub|crate|super|extern|move|break|continue)\b 1:keyword
